  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (profileImageFile) {
        ...
        const response = await axios.put(`${process.env.REACT_APP_API_URL}/api/updateprofile`, formData, {
          headers: {
        ...
        const response = await axios.put(`${process.env.REACT_APP_API_URL}/api/updateprofile`, updateData, config);
